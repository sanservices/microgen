...
import (
	...
	{% if cookiecutter.use_database == 'y' %}"{{ cookiecutter.module_name }}/internal/{{ cookiecutter.service_name }}/repository/mysql"{% endif %}
	{% if cookiecutter.use_database == 'y' %}"{{ cookiecutter.module_name }}/internal/{{ cookiecutter.service_name }}/repository/oracle"{% endif %}
	{% if cookiecutter.use_database == 'y' %}"{{ cookiecutter.module_name }}/internal/{{ cookiecutter.service_name }}/repository/sqlite"{% endif %}
)

// ErrInvalidDBEngine database engine is not supported
var ErrInvalidDBEngine = errors.New("unsupported or missing database engine")
